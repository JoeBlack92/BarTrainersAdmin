/**
 * Created by puesto1 on 1/9/16.
 */

App.info({
    id: 'com.bartrainers.admin',
    name: 'Bartrainers',
    description: 'Aplicación para Barmans y Cocteleros',
    author: 'IndianWebs Poblenou',
    email: 'jmartinez@indianwebs.com',
    website: 'http://indianwebs.com'
});
